...
const JOAF = {
  ...
  pushMessages: {
    ...
    unity:      { title: "🤝 একসাথে থাকি", body: "কমিউনিটিতে পারস্পরিক সহায়তার নতুন সমন্বয় চালু হয়েছে। পাশে থাকুন।" },
    support:    { title: "🫶 সহায়তা দরকার", body: "আপনার এলাকার একটি পরিবার জরুরি সহায়তা চেয়েছে। সামর্থ্য অনুযায়ী এগিয়ে আসুন।" },
    prayer:     { title: "🕌 দোয়া ও সংহতি", body: "নামাজের সময়ের পর কমিউনিটি সাপোর্ট আপডেট দেখুন ও যুক্ত হোন।" },
  },
  ...
  ticker: [
    ...
    { text:"📄 নতুন প্রেস রিলিজ দেখুন",                       href:"/media-news.html"      },
  ]
};

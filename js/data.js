...
const JOAF = {
  ...
  nav: [
    ...
    { label: "💡 আমরা কে", href: "/index.html#about-area",   id: "about"      },
    { label: "✊ যোগ দিন", href: "/membership.html",         id: "membership" },
    { label: "💚 সহযোগিতা",href: "/donate.html",             id: "donate"     },
    { label: "📬 যোগাযোগ",href: "/index.html#footer-area",  id: "contact"    },
  ],
  ...
  communityGroups: [
    ...
    { cat:"main",   name:"JOAF অ্যাডমিনিস্ট্রেশন",      meta:"অ্যাডমিন/কোর টিম",              cover:"অ্যাডমিন",           whatsapp:"#" },
    // আঞ্চলিক — বাংলাদেশ
    ...
    { cat:"regional", name:"JOAF বগুড়া",      meta:"বগুড়া জেলা",        lat:24.8500, lng:89.3700,  whatsapp:"#" },
    { cat:"regional", name:"JOAF ফরিদপুর",    meta:"ফরিদপুর জেলা",      lat:23.6066, lng:89.8406,  whatsapp:"#" },
    { cat:"regional", name:"JOAF দোহার-নবাবগঞ্জ",meta:"ঢাকা (দোহার-নবাবগঞ্জ)", lat:23.6200, lng:90.1000, whatsapp:"#" },
    { cat:"regional", name:"JOAF গাজীপুর",    meta:"গাজীপুর জেলা",      lat:23.9981, lng:90.4203,  whatsapp:"#" },
    { cat:"regional", name:"JOAF জামালপুর",   meta:"জামালপুর জেলা",     lat:24.9196, lng:89.9481,  whatsapp:"#" },
    { cat:"regional", name:"JOAF মাদারীপুর",  meta:"মাদারীপুর জেলা",    lat:23.1710, lng:90.2094,  whatsapp:"#" },
    { cat:"regional", name:"JOAF কুমিল্লা",   meta:"কুমিল্লা জেলা",     lat:23.4619, lng:91.1809,  whatsapp:"#" },
    // আন্তর্জাতিক
    ...
    { cat:"special", name:"ভাইরাল গ্রুপ",            meta:"মিডিয়া প্রচার",          cover:"ভাইরাল গ্রুপ",       whatsapp:"#" },
    { cat:"special", name:"JOAF কনটেন্ট ক্রিয়েটর",  meta:"ডিজাইন/ভিডিও/কনটেন্ট",  cover:"কনটেন্ট ক্রিয়েটর",  whatsapp:"#" },
    { cat:"special", name:"JOAF প্রিমিয়াম সদস্য",   meta:"প্রিমিয়াম সাপোর্টার",   cover:"প্রিমিয়াম",          whatsapp:"#" },
    // সম্প্রসারণ
    { cat:"expand", name:"JOAF অ্যাডভাইজরি বোর্ড",  meta:"অনুরোধ মুলতুবি",       cover:"অ্যাডভাইজরি বোর্ড",  whatsapp:"#" },
    { cat:"expand", name:"JOAF কেরানীগঞ্জ",           meta:"অনুরোধ মুলতুবি",       lat:23.6823, lng:90.3119,   whatsapp:"#" },
  ],

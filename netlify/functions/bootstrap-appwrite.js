...
const COLLECTIONS = {
  ...
  leaders: {
    ...
    attributes: [
      ...
      { type: 'string',  key: 'party',         size: 200,  required: false },
      { type: 'string',  key: 'role',          size: 200,  required: false },
      { type: 'string',  key: 'cat',           size: 50,   required: false },
      { type: 'string',  key: 'icon',          size: 10,   required: false },
      { type: 'bool',    key: 'isDeceased',                required: false },
      { type: 'bool',    key: 'viral',                     required: false },
      { type: 'integer', key: 'approval',                  required: false },
      { type: 'string',  key: 'promises',      size: 5000, required: false },
      { type: 'string',  key: 'statements',    size: 3000, required: false },
      { type: 'string',  key: 'controversies', size: 3000, required: false },
      { type: 'string',  key: 'virals',        size: 3000, required: false },
      { type: 'string',  key: 'lastAiUpdate',  size: 10,   required: false },
      { type: 'string',  key: 'discoveredOn',  size: 10,   required: false },
      { type: 'string',  key: 'source',        size: 50,   required: false },
    ],
    indexes: [
      { key: 'idx_cat',           type: IndexType.Key, attributes: ['cat'] },
      { key: 'idx_viral',         type: IndexType.Key, attributes: ['viral'] },
      { key: 'idx_lastAiUpdate',  type: IndexType.Key, attributes: ['lastAiUpdate'] },
    ],
  },
  ...
  timeline: {
    ...
    attributes: [
      ...
      { type: 'string',  key: 'desc',    size: 2000, required: false },
      { type: 'string',  key: 'type',    size: 20,   required: false },
      { type: 'string',  key: 'tags',    size: 500,  required: false },
      { type: 'string',  key: 'addedOn', size: 10,   required: false },
    ],
    indexes: [
      { key: 'idx_addedOn', type: IndexType.Key, attributes: ['addedOn'], orders: ['DESC'] },
      { key: 'idx_type',    type: IndexType.Key, attributes: ['type'] },
    ],
  },

  leader_discovery_meta: {
    name: 'leader_discovery_meta',
    permissions: [],
    attributes: [
      { type: 'string', key: 'lastRunBdDate', size: 10, required: false },
      { type: 'string', key: 'updatedAt',     size: 30, required: false },
    ],
    indexes: [],
  },
